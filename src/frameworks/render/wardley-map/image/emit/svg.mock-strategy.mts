// Mock strategy for `render:wardley-map:image:emit:svg` (ast-schema.md v0.1.0 § 3.4 — status: "mock").
//
...
export interface RenderWardleyMapImageEmitSvgInput {
...
export class MockRenderWardleyMapImageEmitSvgStrategy extends CoreBaseStrategy<RenderWardleyMapImageEmitSvgInput, RenderWardleyMapImageEmitSvgResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: RenderWardleyMapImageEmitSvgInput,
