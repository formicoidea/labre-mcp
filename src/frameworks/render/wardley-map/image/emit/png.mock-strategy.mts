// Mock strategy for `render:wardley-map:image:emit:png` (ast-schema.md v0.1.0 § 3.4 — status: "mock").
//
...
export interface RenderWardleyMapImageEmitPngInput {
...
export class MockRenderWardleyMapImageEmitPngStrategy extends CoreBaseStrategy<RenderWardleyMapImageEmitPngInput, RenderWardleyMapImageEmitPngResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: RenderWardleyMapImageEmitPngInput,
