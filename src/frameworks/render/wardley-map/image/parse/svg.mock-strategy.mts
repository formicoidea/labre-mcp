// Mock strategy for `render:wardley-map:image:parse:svg` (ast-schema.md v0.1.0 § 3.4 — status: "mock").
//
...
export interface RenderWardleyMapImageParseSvgInput {
...
export class MockRenderWardleyMapImageParseSvgStrategy extends CoreBaseStrategy<RenderWardleyMapImageParseSvgInput, RenderWardleyMapImageParseSvgResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: RenderWardleyMapImageParseSvgInput,
