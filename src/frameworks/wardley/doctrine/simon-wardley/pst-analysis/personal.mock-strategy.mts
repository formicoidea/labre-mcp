// Mock strategy for `wardley:doctrine:simon-wardley:pst-analysis:personal` (ast-schema.md v0.1.0 § 3.4 — status: "mock").
//
...
const METHOD_ID = 'wardley:doctrine:simon-wardley:pst-analysis:personal';

export interface WardleyDoctrineSimonWardleyPstAnalysisPersonalInput {
  // Open shape — the real strategy will narrow this when implemented.
  // any: mock-strategy input is intentionally open
  [key: string]: unknown;
}

export interface WardleyDoctrineSimonWardleyPstAnalysisPersonalResult {
  mock: true;
  methodId: string;
...
export class MockWardleyDoctrineSimonWardleyPstAnalysisPersonalStrategy extends CoreBaseStrategy<WardleyDoctrineSimonWardleyPstAnalysisPersonalInput, WardleyDoctrineSimonWardleyPstAnalysisPersonalResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: WardleyDoctrineSimonWardleyPstAnalysisPersonalInput,
    _context: RequestContext,
  ): Promise<StrategyResult<WardleyDoctrineSimonWardleyPstAnalysisPersonalResult>> {
