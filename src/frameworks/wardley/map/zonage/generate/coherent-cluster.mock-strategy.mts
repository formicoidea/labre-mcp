...
export class MockWardleyMapZonageGenerateCoherentClusterStrategy extends CoreBaseStrategy<WardleyMapZonageGenerateCoherentClusterInput, WardleyMapZonageGenerateCoherentClusterResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: WardleyMapZonageGenerateCoherentClusterInput,
    _context: RequestContext,
  ): Promise<StrategyResult<WardleyMapZonageGenerateCoherentClusterResult>> {
