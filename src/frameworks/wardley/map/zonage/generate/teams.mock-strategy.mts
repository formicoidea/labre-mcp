...
export class MockWardleyMapZonageGenerateTeamsStrategy extends CoreBaseStrategy<WardleyMapZonageGenerateTeamsInput, WardleyMapZonageGenerateTeamsResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: WardleyMapZonageGenerateTeamsInput,
    _context: RequestContext,
  ): Promise<StrategyResult<WardleyMapZonageGenerateTeamsResult>> {
