...
export class MockWardleyMapZonageGeneratePstAnalysisStrategy extends CoreBaseStrategy<WardleyMapZonageGeneratePstAnalysisInput, WardleyMapZonageGeneratePstAnalysisResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: WardleyMapZonageGeneratePstAnalysisInput,
    _context: RequestContext,
  ): Promise<StrategyResult<WardleyMapZonageGeneratePstAnalysisResult>> {
