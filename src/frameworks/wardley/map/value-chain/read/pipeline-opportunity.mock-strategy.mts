...
export class MockWardleyMapValueChainReadPipelineOpportunityStrategy extends CoreBaseStrategy<WardleyMapValueChainReadPipelineOpportunityInput, WardleyMapValueChainReadPipelineOpportunityResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: WardleyMapValueChainReadPipelineOpportunityInput,
    _context: RequestContext,
  ): Promise<StrategyResult<WardleyMapValueChainReadPipelineOpportunityResult>> {
