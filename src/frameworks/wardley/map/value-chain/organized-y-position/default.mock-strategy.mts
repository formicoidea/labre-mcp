...
export class MockWardleyMapValueChainOrganizedYPositionDefaultStrategy extends CoreBaseStrategy<WardleyMapValueChainOrganizedYPositionDefaultInput, WardleyMapValueChainOrganizedYPositionDefaultResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: WardleyMapValueChainOrganizedYPositionDefaultInput,
    _context: RequestContext,
  ): Promise<StrategyResult<WardleyMapValueChainOrganizedYPositionDefaultResult>> {
