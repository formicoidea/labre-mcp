// Mock strategy for `common:toolbox:list:emit:default` (ast-schema.md v0.1.0 § 3.4 — status: "mock").
//
...
export class MockCommonToolboxListEmitDefaultStrategy extends CoreBaseStrategy<CommonToolboxListEmitDefaultInput, CommonToolboxListEmitDefaultResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: CommonToolboxListEmitDefaultInput,
    _context: RequestContext,
  ): Promise<StrategyResult<CommonToolboxListEmitDefaultResult>> {
