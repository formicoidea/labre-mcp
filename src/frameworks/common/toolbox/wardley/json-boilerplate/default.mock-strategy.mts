// Mock strategy for `common:toolbox:wardley:json-boilerplate:default` (ast-schema.md v0.1.0 § 3.4 — status: "mock").
//
...
const METHOD_ID = 'common:toolbox:wardley:json-boilerplate:default';

export interface CommonToolboxWardleyJsonBoilerplateDefaultInput {
  // Open shape — the real strategy will narrow this when implemented.
  // any: mock-strategy input is intentionally open
  [key: string]: unknown;
}

export interface CommonToolboxWardleyJsonBoilerplateDefaultResult {
  mock: true;
  methodId: string;
...
export class MockCommonToolboxWardleyJsonBoilerplateDefaultStrategy extends CoreBaseStrategy<CommonToolboxWardleyJsonBoilerplateDefaultInput, CommonToolboxWardleyJsonBoilerplateDefaultResult> {
  static get method(): string { return METHOD_ID; }

  async evaluate(
    _input: CommonToolboxWardleyJsonBoilerplateDefaultInput,
    _context: RequestContext,
  ): Promise<StrategyResult<CommonToolboxWardleyJsonBoilerplateDefaultResult>> {
